...
# Paths
BACKGROUND_PATH = 'Shooter/Background.png'
BASE_PATH = 'Shooter/pixil-layer-Background.png'
PLAYER_PATH = 'Shooter/ShooterSprite.png'
PROJECTILE_PATHS = [
    'Shooter/p1.png',
    'Shooter/p2.png',
    'Shooter/p3.png'
...
class Player:
    def __init__(self, game):
        ...
        self.BLUE_BALLS = 5 # how many loads before punishment
